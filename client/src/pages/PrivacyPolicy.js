        ...
        <div style={{
          ...
          <section style={{ marginBottom: 'var(--space-8)' }}>
            ...
            <p style={{
              ...
              ونلتزم بالشفافية الكاملة حول كيفية جمع واستخدام وحماية بياناتك الشخصية.
              هذه السياسة توضح بالتفصيل ممارساتنا المتعلقة بالخصوصية وحقوقك كمستخدم.
            </p>
          </section>
          ...
          <section style={{ marginBottom: 'var(--space-8)' }}>
            ...
            <ul style={{
              ...
              <li style={{ marginBottom: 'var(--space-2)' }}>
                <strong style={{ color: isDarkMode ? '#ffffff' : '#1f2937' }}>تسهيل الخدمة:</strong> لربط السائقين والركاب وتنظيم الرحلات
              </li>
              <li style={{ marginBottom: 'var(--space-2)' }}>
                <strong style={{ color: isDarkMode ? '#ffffff' : '#1f2937' }}>التواصل:</strong> لإرسال الإشعارات المهمة حول الحجوزات والرحلات
              </li>
              <li style={{ marginBottom: 'var(--space-2)' }}>
                <strong style={{ color: isDarkMode ? '#ffffff' : '#1f2937' }}>الأمان:</strong> للتحقق من الهوية ومنع الاحتيال
              </li>
              <li style={{ marginBottom: 'var(--space-2)' }}>
                <strong style={{ color: isDarkMode ? '#ffffff' : '#1f2937' }}>تحسين الخدمة:</strong> لتحليل الأداء وتطوير ميزات جديدة
              </li>
              <li style={{ marginBottom: 'var(--space-2)' }}>
                <strong style={{ color: isDarkMode ? '#ffffff' : '#1f2937' }}>الدعم الفني:</strong> لحل المشاكل والإجابة على الاستفسارات
              </li>
            </ul>
          </section>
          ...
          <section style={{ marginBottom: 'var(--space-8)' }}>
            ...
            <div style={{
              ...
              <ul style={{
                ...
                <li style={{ marginBottom: 'var(--space-2)' }}>
                  <strong style={{ color: isDarkMode ? '#ffffff' : '#1f2937' }}>التشفير:</strong> جميع البيانات الحساسة مشفرة باستخدام معايير الصناعة (SSL/TLS)
                </li>
                <li style={{ marginBottom: 'var(--space-2)' }}>
                  <strong style={{ color: isDarkMode ? '#ffffff' : '#1f2937' }}>التخزين الآمن:</strong> الخوادم محمية بجدران نارية متقدمة ونظم مراقبة على مدار الساعة
                </li>
                <li style={{ marginBottom: 'var(--space-2)' }}>
                  <strong style={{ color: isDarkMode ? '#ffffff' : '#1f2937' }}>الوصول المحدود:</strong> فقط الموظفون المصرح لهم يمكنهم الوصول للبيانات الحساسة
                </li>
                <li style={{ marginBottom: 'var(--space-2)' }}>
                  <strong style={{ color: isDarkMode ? '#ffffff' : '#1f2937' }}>المراجعة الدورية:</strong> نجري تدقيقات أمنية منتظمة لضمان سلامة البيانات
                </li>
              </ul>
            </div>
          </section>
          ...
          <section style={{ marginBottom: 'var(--space-8)' }}>
            ...
            <p style={{
              ...
              نحن <strong style={{ color: isDarkMode ? '#ffffff' : '#1f2937' }}>لا نبيع</strong> بياناتك الشخصية لأطراف ثالثة.
              قد نشارك بيانات محدودة فقط في الحالات التالية:
            </p>
            <ul style={{
              paddingRight: '20px',
              color: isDarkMode ? 'rgba(255, 255, 255, 0.8)' : '#374151',
              ...
              <li style={{ marginBottom: 'var(--space-2)' }}>
                مع مزودي الخدمات الذين يساعدوننا في تشغيل التطبيق (مثل خدمات الاستضافة) بموجب اتفاقيات سرية صارمة
              </li>
              <li style={{ marginBottom: 'var(--space-2)' }}>
          ...
          <section style={{ marginBottom: 'var(--space-8)' }}>
            ...
            <div style={{
              ...
              <ul style={{
                ...
                <li style={{ marginBottom: 'var(--space-2)' }}>
                  <strong style={{ color: isDarkMode ? '#ffffff' : '#1f2937' }}>الوصول:</strong> يمكنك طلب نسخة من بياناتك الشخصية
                </li>
                <li style={{ marginBottom: 'var(--space-2)' }}>
                  <strong style={{ color: isDarkMode ? '#ffffff' : '#1f2937' }}>التصحيح:</strong> يمكنك تحديث أو تصحيح معلوماتك في أي وقت
                </li>
                <li style={{ marginBottom: 'var(--space-2)' }}>
                  <strong style={{ color: isDarkMode ? '#ffffff' : '#1f2937' }}>الحذف:</strong> يمكنك طلب حذف حسابك وبياناتك بشكل دائم
                </li>
                <li style={{ marginBottom: 'var(--space-2)' }}>
                  <strong style={{ color: isDarkMode ? '#ffffff' : '#1f2937' }}>التقييد:</strong> يمكنك طلب تقييد معالجة بياناتك
                </li>
                <li style={{ marginBottom: 'var(--space-2)' }}>
                  <strong style={{ color: isDarkMode ? '#ffffff' : '#1f2937' }}>الاعتراض:</strong> يمكنك الاعتراض على معالجة بياناتك في حالات معينة
                </li>
              </ul>
            </div>
          </section>
          ...
          <section style={{
            ...
            <p style={{
              ...
              إذا كان لديك أي أسئلة أو استفسارات حول سياسة الخصوصية أو حقوقك،
              يرجى التواصل معنا:
            </p>
            <div style={{
              display: 'flex',
          ...
          <div style={{
            ...
            <p style={{
              ...
              سياسة الخصوصية هذه قد تتغير من وقت لآخر، وسنقوم بإخطارك بأي تغييرات جوهرية.
            </p>
          </div>
        </div>
      </div>
