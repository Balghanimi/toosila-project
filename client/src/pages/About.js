        ...
        <div style={{
          ...
          <section style={{ marginBottom: 'var(--space-8)' }}>
            ...
            <p style={{
              ...
              <strong style={{ color: isDarkMode ? '#34c759' : '#28a745' }}>توصيلة</strong> هي منصة عربية متطورة لمشاركة الرحلات بين المدن والأحياء.
              نربط السائقين الذين لديهم مقاعد فارغة في سياراتهم مع الركاب الذين يبحثون عن رحلات مريحة وآمنة وبأسعار معقولة.
            </p>
            <p style={{
              color: isDarkMode ? 'rgba(255, 255, 255, 0.8)' : '#374151',
              fontSize: 'var(--text-base)'
            }}>
              مهمتنا هي جعل السفر أكثر سهولة واقتصادية وصداقة للبيئة من خلال تقليل عدد السيارات على الطرق
              وتوفير تجربة آمنة وموثوقة لجميع المستخدمين.
            </p>
          </section>
          ...
          <section style={{ marginBottom: 'var(--space-8)' }}>
            ...
            <p style={{
              ...
              أن نكون المنصة الرائدة في العالم العربي لمشاركة الرحلات، حيث نسعى لخلق مجتمع من المسافرين
              الذين يثقون ببعضهم البعض ويساعدون في بناء مستقبل أكثر استدامة من خلال الاستخدام الأمثل للموارد المتاحة.
            </p>
          </section>
              ...
              {[
                ...
                <div key={index} style={{
                  ...
                  background: isDarkMode
                    ...
                    : `${feature.color}08`,
                  borderRadius: 'var(--radius-lg)',
                  border: isDarkMode ? `1px solid ${feature.color}30` : `2px solid ${feature.color}20`,
                  ...
                  onMouseLeave={(e) => {
                    ...
                    e.currentTarget.style.borderColor = isDarkMode ? `${feature.color}30` : `${feature.color}20`;
                  }}
                >
            ...
            <div style={{ display: 'grid', gap: 'var(--space-4)' }}>
              ...
              <div style={{
                ...
                <ol style={{
                  ...
                  <li style={{ marginBottom: 'var(--space-2)' }}>سجل حسابك كسائق وأضف معلومات مركبتك</li>
                  <li style={{ marginBottom: 'var(--space-2)' }}>انشر عرض رحلتك مع تحديد الوجهة والسعر والتاريخ</li>
              ...
              <div style={{
                ...
                <ol style={{
                  ...
                  <li style={{ marginBottom: 'var(--space-2)' }}>ابحث عن الرحلات المتاحة حسب وجهتك</li>
          ...
          <section style={{
            ...
            <div style={{
              ...
              <a
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.transform = 'translateX(-4px)';
                  e.currentTarget.style.background = isDarkMode ? 'rgba(52, 199, 89, 0.25)' : '#f0fdf4';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = 'translateX(0)';
                  e.currentTarget.style.background = isDarkMode ? 'rgba(52, 199, 89, 0.15)' : 'white';
                }}
              >
          ...
          <div style={{
            ...
            <p style={{
              ...
              <strong style={{ color: isDarkMode ? '#3b82f6' : '#1d4ed8' }}>توصيلة</strong> - تطبيق مشاركة الرحلات
            </p>
            <p style={{
